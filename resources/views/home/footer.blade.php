<!-- Start Footer Area -->
<footer class="footer-area site-url" data-url="index" style="background: url('{{ asset(" assets/images/ff.png") }}')
    ...
    <div class="container">
        ...
        <div class="copyright-area">
            <p>&copy; 2025 <a href="#"> Swift Credit Pay</a>. All rights reserved</p>
        </div>
    </div>
