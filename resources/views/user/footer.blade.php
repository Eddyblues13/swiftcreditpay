                            ...
                            <a href="user/alert" class="item">
                                <div class="detail"> <span class="fas fa-helicopter image-block imaged w48"></span>
                                    <div> <strong>Plane Tickets</strong>
                                        <p>Buy Flight tickets from your Swift Credit Pay's Account.</p>
                                    </div>
                                </div>
                            </a>
                            <!-- * item -->
...
<div id="cookiesbox" class="offcanvas offcanvas-bottom cookies-box" tabindex="-1" data-bs-scroll="true"
    ...
    <div class="offcanvas-body">
        <div>
            Swift Credit Pay uses cookies to provide necessary website functionality, improve your experience and
...
s1.async=true;
s1.src='https://embed.tawk.to/68575495f4cfc5190e97ef6d/1iuai4r0e';
s1.charset='UTF-8';
